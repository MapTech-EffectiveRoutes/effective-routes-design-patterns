...
function clientCode() {
    ...
    let folder1File1: FileSystemComponent = new FileComponent("Jun1DataFile.txt", 4000);
    let folder1File2: FileSystemComponent = new FileComponent("Jun2DataFile.txt", 6000);
    ...
    let folder2File1: FileSystemComponent = new FileComponent("Jul1DataFile.txt", 3000);
    let folder2File2: FileSystemComponent = new FileComponent("Jul2DataFile.txt", 5000);
