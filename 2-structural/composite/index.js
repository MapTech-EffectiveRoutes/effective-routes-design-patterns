...
function clientCode() {
    ...
    var folder1File1 = new file_component_1.FileComponent("Jun1DataFile.txt", 4000);
    var folder1File2 = new file_component_1.FileComponent("Jun2DataFile.txt", 6000);
    ...
    var folder2File1 = new file_component_1.FileComponent("Jul1DataFile.txt", 3000);
    var folder2File2 = new file_component_1.FileComponent("Jul2DataFile.txt", 5000);
